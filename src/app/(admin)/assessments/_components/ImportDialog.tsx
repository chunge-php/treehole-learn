...
export function ImportDialog({ open, onOpenChange, onDone }: { open: boolean; onOpenChange: (v: boolean) => void; onDone?: () => void }) {
  return (
    <BulkImportDialog
      ...
      onDone={onDone}
      title="批量导入测评题"
      description="所属维度填中文 (多元性向量表/自陈量表/兴趣量表/多模态), 题型填中文 (单选题/判断题/语音题); 题目内容为 JSON 数组或 | 分隔; 序号留空自动分配。"
      templateFields={[
        ...
        { key: "options", label: "题目内容", example: '[{"label":"反复思考","value":"A","score":4},{"label":"换题再说","value":"B","score":2}]' },
